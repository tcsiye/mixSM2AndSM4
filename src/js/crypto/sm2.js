const KJUR = require('../ext/ecparam-1.0.js')
const ECPointFp = require('../utils/ec-patch.js')
const SM3Digest = require('./sm3.js')
const BigInteger = require('../ext/jsbn2.js')
...
SM2Cipher.prototype = {
	...
	InitEncipher : function(userKey) {
		...
		this.p2 = userKey.multiply(k);this.Reset();return c1
	},

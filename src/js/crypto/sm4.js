 ...
 */
 ...
 const byteArrayToIntArray = require('../utils/byteUtil.js').byteArrayToIntArray
 const byteToInt = require('../utils/byteUtil.js').byteToInt
 const intToByte = require('../utils/byteUtil.js').intToByte
 const arrayCopy = require('../utils/byteUtil.js').arrayCopy
 const intArrayToByteArray = require('../utils/byteUtil.js').intArrayToByteArray
